                  ...
                  <div class="col-lg-6">
                    <fieldset>
                      ...
                      <div class="form-group"><label class="col-sm-2 control-label">Nombre(s)</label>
                        <div class="col-sm-10"><input required placeholder="" name="nombre"  type="text" class="form-control"></div>
                      </div>
                      <div class="form-group"><label class="col-sm-2 control-label">Apellidos</label>
                        <div class="col-sm-10"><input required type="text" name="apellido" class="form-control"></div>
                      </div>
                  ...
                  <div class="col-lg-6">
                    <fieldset>
                      ...
                      <div class="form-group"><label class="col-sm-2 control-label">Telefono</label>
                        <div class="col-sm-10"><input onkeypress="return validanum(event)" maxlength="10" required type="text" name="tel" placeholder="" class="form-control"></div>
                      </div>
                      <div class="form-group"><label class="col-sm-2 control-label">Correo electrónico</label>
                        <div class="col-sm-10"><input required type="text" name="coel" placeholder="" class="form-control"></div>
                      </div>
                      <div class="form-group"><label class="col-sm-2 control-label">Tipo de tramite</label>
